# The Ō no Kotodama — The King's Word (王の言霊)
...
2. **The Literal → Intent spectrum — the curse at the heart of the story.** How the Word interprets a command depends on how *strong* the carrier is. This is the single most important rule; it drives both the tragedy and the corruption arc.
   - **Weak / untrained (where both boys begin):** the Word obeys the *words spoken*, not the intent behind them. The body parses the sentence like a cruelly literal machine. The carrier's own meaning is irrelevant — only the surface grammar reaches the target.
     - "Let her go" → the hands release. Even over a ledge. **(This is the tragedy engine. On the roof an FDC soldier held Ryn out as leverage — *come quiet or I drop her* — and Kaito's Word opened the hand. It only killed her *because Kaito was weak*: the untrained Word took the surface grammar. A stronger Kaito's power would have heard what he meant: *stop threatening her / get her safe.* His weakness is what made his love lethal.)**
     - "Drop it" → the *hands* open and the object falls, whatever it is (the command lands on the holder, never the object — see Rule 1b). "Freeze" → the body locks. "Get lost" → the target may wander and be unable to find the way back.
   - **Growing / trained:** the Word starts to "listen past" the words — it samples the picture in the carrier's mind and blends it with the sentence. Idioms stop misfiring. The command begins to do roughly what you *meant*.
   - **Strong / apex:** intent becomes the spell. The words are just the trigger that lets it out; the Word reads the desire behind them and enacts *that*. A whispered, sloppy sentence from a strong carrier can do exactly, terribly, what they wanted — including things they didn't have the courage to say out loud.
   - **Why this is scarier, not safer:** the literal stage at least had a fail-safe — a monster who misspoke could misfire harmlessly. The intent stage removes the excuse entirely. Once the Word reads intent, **every command is exactly as cruel as the heart behind it.** A corrupting carrier's ugliest half-thought becomes an order.

3. **Clarity / sentence-building — the discipline of the power.** Because the early Word is literal, *how you build the sentence* is everything, and a carrier's effectiveness scales with the precision of their language as much as with raw strength.
   - **Ambiguity is dangerous.** A vague command gets a vague, often literal, sometimes catastrophic result. "Deal with him" could do a dozen things; the body picks the flattest reading. "Stop" begs the question *stop what* — breathing? a heartbeat? Untrained carriers must speak with terrifying care.
   - **Specificity is power.** A clean, unambiguous, well-scoped command ("walk three steps back and sit on the bench") lands cleanly and costs less Backwash than a muddy one the Word has to fight to interpret.
   - **Training the Word is training your grammar.** Part of what a mentor (or Mira) teaches is *sentence-craft*: naming the target, bounding the action, closing loopholes — the way a lawyer or a programmer writes to leave nothing to interpretation. As a carrier climbs the Literal→Intent spectrum this discipline matters less (intent covers for sloppy words), which is itself a temptation: the stronger you get, the lazier and more dangerous your mouth is allowed to be.
   - **Character contrast:** Haruki is instinctively *precise* (his whole narration is careful, scoped, hedged) but aims *soft* — so his clean grammar produces gentle results. Kaito is *imprecise* and *loud* — which is exactly why his careless idiom killed. The tragedy is a grammar error with a body count.
...
- **What it does:** Edits a spoken sentence before it finishes landing. He can change subject, person, target, a verb — but **sentence structure stays the same**. Same beat count, same order, same shape. Example: "Let her go" → "Let *him* go" (not "Hold her").
- **How it looks on-page (Ch 47 lock):** No finger signature. No second spoken line for the crowd. Kuroda finishes the sentence with his own mouth **silent**; bystanders (and Haruki) hear only the Rewritten line as if it came from the speaker. The speaker alone knows what they meant. Demo Ch 47: first Word aimed at Kuroda — Kaito means *"Kneel"* → bank hears *"Stand"* (already-kneeling cordon stands; Kuroda never dips); means shoot Kuroda → bank hears shoot Mira (round hits mud; Riku hauls her clear).
...
- **Story role (Ch 3–46):** Deniable tells (crowd hears the "wrong" word for a beat); quiet shaping of both boys through Grade I → **II**. **(Paid Ch 47):** Named on-page; silent mouth-finish Rewrite demoed on Kaito (*Kneel*→*Stand*; shoot-him→shoot-her); care/erase monologue; then Haruki's *Stop* clashes with Kaito's *Die* and Kuroda vanishes with Kaito, Mei, and Ide. Reversion is stated as his want; whether he lives to pursue it is now unknown.
...
## How it appears in Chapters 1-2 (deniable hints only)
The reader should *feel* something is off; no one in-story should name it yet.
- People comply with Haruki and Kaito a beat too smoothly — a shopkeeper, a bully, a teacher — always explainable as charisma or luck.
- Both boys occasionally get a small nosebleed or a moment of their own voice "catching," right after such a moment. Coded as stress, allergies, puberty.
