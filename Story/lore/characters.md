...
- **Status (live, end Ch 29):** Remnant raider at Shizuhara. West-fence breach; Worded bay clerk + specials guard; Mira's clean extract already dirty; face-to-face with **Serizawa Mei** in east corridor. Does not know Haruki/Riku are in C. Massacre-hollow not yet.
...
- **On-page (Ch 29, Kaito camera):** Meets Mira/Kaito/contact in east corridor after specials door opens; names herself; dirty-extract confront; asks who they came for.
- **Status (live):** On-page through Ch 29 (both cameras). Destination of night trucks still unsold; no heir dump.
...
- **Continuity (live):** Ch 4–12 as before (ordinary neighbor → witness → steer; Kuroishi; Ishibashi; Takamatsu split). **Ch 19–23:** Clean apartment via contact; Suzumori extraction; pine fringe / inland; argues Suzumori on throat-as-latch; does not stop *Go home*; carries Kaito west. Contact (unnamed) live through shed/lean-to. Steering harder. **Ch 29:** Brings Remnant clean extract to Shizuhara west fence; abort window lost when lights hit; still pointing doors, not selling a wipe yet.
