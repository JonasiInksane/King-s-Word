...
- **Status (end Ch 12, camera dark until Ch 19):** Lethal command paid (Ch 9). Inland with Mira through Kuroishi well Word + Ishibashi fare. Last on-page: walking into the East Yards day-work line, Takamatsu, money thin, water-tower meet pending. Off-camera weeks follow — surface in Ch 19 as status quo (settled room, steady work, standing no-Word-in-city law, Minato regular). Glad-it-worked interior still only on record at Ch 7 buyer test; the well-lift is felt and hated on-page in Ch 11.
...
- **Continuity (live):** Ch 7 — Mira's warning ("he doesn't stamp anything, he just listens") plus the Kōgetsu checkpoint-sergeant story riding the delivery routes. Ch 9 — "advises" the registry, watches the sweep, covers his ears. Ch 10 — works through everyone who stood near the shooter, name by name; places Haruki to the meter ("between the well and the cistern shed"); is believed *faster than the lie deserves* and moves on, taking Haruki for nothing.
...
- **Meeting pattern (live + ARCHIVE plan):** Train (Ch 3, live) → then archive plan: Nagihama edges → Bar Minato / lane → Shizuhara lobby edge → Susuichi true re-meet → Rewrite clear demo → endgame. Re-stage against the new outline.
